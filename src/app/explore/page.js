...
export default function ExplorePage() {
  ...
  const setFilter = (key, value) => {
    ...
    if (typeof window !== "undefined" && window.gtag) {
      window.gtag("event", "explore_filter_used", {
        filter_key: key,
        filter_value: value,
      });
    }
          ...
          >
            ...
            >
              ...
              >
                ...
                <a
                  href={`https://wa.me/919404799469?text=${encodeURIComponent(
                    "Hi, I'm looking for a PG. Here are my details:\n\nFull name - \nMobile number - \nLocation - \nBudget - \nExpected move-in date - \nExpected stay (months) - ",
                  )}`}
                  target="_blank"
              ...
              >
                WhatsApp works instantly — no login needed
              </p>
            </div>
          </div>
        </div>
